...
export default function TaskGroupActions({ group, ...props }) {
  const archiveForm = useForm(
    'delete',
    route('projects.boards.task-groups.destroy', [group.project_id, route().params.board, group.id])
  );
  const restoreForm = useForm(
    'post',
    route('projects.boards.task-groups.restore', [group.project_id, route().params.board, group.id])
  );
