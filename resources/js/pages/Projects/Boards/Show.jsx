...
import useBoardsStore from '@/hooks/store/useBoardsStore';
...
import { CreateTaskDrawer } from '../Tasks/Drawers/CreateTaskDrawer';
import { EditTaskDrawer } from '../Tasks/Drawers/EditTaskDrawer';
import ArchivedItems from '../Tasks/Index/Archive/ArchivedItems';
import Filters from '../Tasks/Index/Filters';
import FiltersDrawer from '../Tasks/Index/FiltersDrawer';
import Header from '../Tasks/Index/Header';
import CreateTasksGroupModal from '../Tasks/Index/Modals/CreateTasksGroupModal';
import TaskGroup from '../Tasks/Index/TaskGroup';
import classes from '../Tasks/css/Index.module.css';

let currentProject = null;

const BoardShow = () => {
  const { project, board, boards, taskGroups, groupedTasks, openedTask } = usePage().props;
  ...
  const { setBoards, setActiveBoard } = useBoardsStore();
...
BoardShow.layout = page => (
  <ProjectWorkspaceLayout title={currentProject?.name}>{page}</ProjectWorkspaceLayout>
);
