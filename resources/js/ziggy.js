const Ziggy = {
  ...
  routes: {
    ...
    'projects.boards.show': {
      ...
      bindings: { project: 'id', board: 'id' },
    },
    'projects.boards.tasks.open': {
      uri: 'projects/{project}/boards/{board}/tasks/{task}/open',
      methods: ['GET', 'HEAD'],
      parameters: ['project', 'board', 'task'],
      bindings: { project: 'id', board: 'id', task: 'id' },
    },
    ...
    'projects.boards.task-groups.store': {
      uri: 'projects/{project}/boards/{board}/task-groups',
      methods: ['POST'],
      parameters: ['project', 'board'],
      bindings: { project: 'id', board: 'id' },
    },
    'projects.boards.task-groups.update': {
      uri: 'projects/{project}/boards/{board}/task-groups/{taskGroup}',
      methods: ['PUT'],
      parameters: ['project', 'board', 'taskGroup'],
      bindings: { project: 'id', board: 'id', taskGroup: 'id' },
    },
    'projects.boards.task-groups.destroy': {
      uri: 'projects/{project}/boards/{board}/task-groups/{taskGroup}',
      methods: ['DELETE'],
      parameters: ['project', 'board', 'taskGroup'],
      bindings: { project: 'id', board: 'id', taskGroup: 'id' },
    },
    'projects.boards.task-groups.restore': {
      uri: 'projects/{project}/boards/{board}/task-groups/{taskGroupId}/restore',
      methods: ['POST'],
      parameters: ['project', 'board', 'taskGroupId'],
      bindings: { project: 'id', board: 'id' },
    },
    'projects.boards.task-groups.reorder': {
      uri: 'projects/{project}/boards/{board}/task-groups/reorder',
      methods: ['POST'],
      parameters: ['project', 'board'],
      bindings: { project: 'id', board: 'id' },
    },
    'projects.boards.tasks.store': {
      uri: 'projects/{project}/boards/{board}/tasks',
      methods: ['POST'],
      parameters: ['project', 'board'],
      bindings: { project: 'id', board: 'id' },
    },
